...
The theory that I love the most (which might very well be outdated by now) for how to describe how and why language has become useful for humans to understand one another is probably those coming out of the [Minimalist Program](https://en.wikipedia.org/wiki/Minimalist_program) (Chomsky), though there are many competing and more modern theories. Definitely worth a read if you’re interested in this stuff.
...
[The Chinese room thought experiment](https://en.wikipedia.org/wiki/Chinese_room) gives a clear mental model to avoid being fooled into thinking good answers from an AI equals cognition.
